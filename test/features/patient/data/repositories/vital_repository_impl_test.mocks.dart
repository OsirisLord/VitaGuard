...
// in vitaguard/test/features/patient/data/repositories/vital_repository_impl_test.dart.
...
import 'package:vitaguard/core/services/websocket_service.dart' as _i2;
...
class MockWebSocketService extends _i1.Mock implements _i2.WebSocketService {
  ...
  @override
  void send(String? data) => super.noSuchMethod(
        Invocation.method(
          #send,
          [data],
        ),
